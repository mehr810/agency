  ...
  return (
    <section className="container mx-auto px-4 md:px-10 py-12 md:py-40">
      ...
      >
        ...
        <div className="relative rounded-2xl overflow-hidden h-[420px] sm:h-[450px] md:h-[480px] lg:h-[500px] xl:h-[550px] w-full bg-gradient-to-br from-white/20 to-transparent backdrop-blur-md border border-white/10">
          <Image
            src="/semless.jpg"
          ...
          {/* Glass overlay sticking to bottom and going upward */}
          <div className="absolute bottom-0 left-0 right-0 h-42 bg-gradient-to-t from-black/70 via-black/50 to-transparent backdrop-blur-md">
            {/* Centered text container */}
            <div className="absolute bottom-7 left-0 right-0 flex flex-col items-center justify-center">
              {/* First line: "Seamless" */}
              <span className="text-white text-4xl font-bold">Seamless</span>

              {/* Second line: Lightning + "Collaboration" */}
              <div className="flex items-center justify-center mt-1">
                ...
                <svg
                  ...
                  className="mr-2"
                >
                  <path d="M4.732,7.95335,6.90908,2h3.63639L8.36364,7.01316h2.90911L4.72725,14,6.93656,7.95135Z"></path>
                </svg>

                {/* "Collaboration" text */}
                <span className="text-white text-4xl font-bold">Collaboration</span>
              </div>
            </div>
          </div>
        </div>
