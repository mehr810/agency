    ...
    <div className="relative w-full my-10">
          ...
          <div className="flex gap-6 ml-[400px]">
            ...
            { label: "Facebook", url: "https://facebook.com" }].map((item, i) => (
              <Link
                ...
                className="w-[258px] h-[82px] flex items-center justify-between rounded-lg bg-[#4B4B4B] text-white px-4 transition-transform hover:scale-105 active:scale-95"
              >
      ...
      <div className="flex flex-col md:hidden space-y-6 mt-6">
        ...
        <div className="flex flex-col items-center space-y-4">
          ...
          <div className="flex flex-wrap justify-center gap-3">
            {[
              ...
              <Link
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="w-[143px] h-[37px] flex items-center justify-between rounded-lg bg-[#4B4B4B] text-white px-3 transition-transform hover:scale-105 active:scale-95 relative z-10 cursor-pointer"
              >
          ...
          <div className="flex flex-wrap justify-center gap-3">
            {[
              ...
              { label: "Instagram", url: "https://www.instagram.com/mightyfive.agency/?igsh=YXJ2eWY1cTBjZHpp#", network: "instagram" }
            ].map((item, i) => (
              <Link
                key={i}
                href={item.url}
        ...
        <div className="grid grid-cols-3 gap-4 w-full text-center mt-2">
          {/* Office Address */}
          <Link href="https://maps.google.com/?q=24/A,+New+Boston+Tower,+New+York,+US" target="_blank" rel="noopener noreferrer" className="flex flex-col items-center hover:underline">
          ...
          {/* 24/7 Support */}
          <Link href="mailto:sales@mighty-five.com" className="flex flex-col items-center hover:underline">
            <div className="w-10 h-10 rounded-full bg-[#2A2A2A] flex items-center justify-center mb-2">
          ...
          {/* Business Hours */}
          <Link href="/contact" className="flex flex-col items-center hover:underline"> {/* Assuming an internal contact page; adjust as needed */}
            <div className="w-10 h-10 rounded-full bg-[#2A2A2A] flex items-center justify-center mb-2">
