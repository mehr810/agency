...
function BigMoes() {
  ...
  {/* Content Container - Reordered for mobile */}
  <div className="flex flex-col md:flex-row items-center md:items-end justify-end w-full order-3 md:order-2 px-4 md:px-0 gap-6 md:gap-0">
    {/* Big Image - First on mobile */}
    <motion.div
      className="relative w-full md:w-[700px] h-auto md:h-[400px] rounded-none overflow-hidden shadow-lg order-1 md:order-1"
    ...
    {/* Small Image - Last on mobile */}
    <motion.div
      className="relative w-full md:w-[320px] h-[200px] md:h-[180px] rounded-b-none overflow-hidden shadow-xl md:translate-y-[39px] order-3 md:order-2"
    ...
    >
      ...
      >
        <Link href="/portfolio/verdent" className="block">
          <button
  ...
  {/* Heading and Toggle Buttons - Middle on mobile */}
  <motion.div
  ...
  >
    <div className="ml-[calc((100%-1040px))] h-[1px] bg-gray-400 flex-1" />
      ...
      <section className="w-full flex flex-col items-center text-center space-y-10 py-12">
          ...
          <div className="flex justify-center gap-10">
            {colors.map((c, i) => (
              <div key={i} className="flex flex-col items-center">
                ...
                />
                <p className="mt-2 text-sm font-mono">{c.hex}</p>
              </div>
            ))}
          </div>
        </div>
        ...
        {/* ✅ Visual Narratives (custom video controls) */}
        <div className="w-full max-w-4xl">
          <h2 className="text-lg font-semibold mb-6 uppercase tracking-wide">
            Visual Narratives
          </h2>
